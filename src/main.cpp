...
unsigned int nStakeMinAge = 60 * 60 * 24 * 14;	//minimum age for coin age:  14 day
unsigned int nStakeMaxAge = 60 * 60 * 24 * 900;	//stake age of full weight:  900 day
unsigned int nStakeTargetSpacing = 60*5;			// 60 *5  sec block spacing

int64 nChainStartTime = 1457650730;
...
const string strMessageMagic = "AlphabetCoinFund Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	nSubsidy = 18900000 * COIN; // Blocks 1-10 are premine
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in AlphabetCoinFund
    bool fStrictPayToScriptHash = true; // Always active in AlphabetCoinFund
...
if (!CheckCoinStakeTimestamp(GetBlockTime(), (int64)vtx[1].nTime))
    ...
    if ((nTime >= CUTOFF_POW_TIME) && (IsProofOfWork()))
         return DoS(100, error("CheckBlock() : Proof of work (%f FUN) at t=%d on or after %d.\n",
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AlphabetCoinFund", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "20160310 FUN proves that pzTimestamp is overkill.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1457650730;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 409216; // perfect nonce
        ...
        assert(block.hashMerkleRoot == uint256("0xe50b34de4c8bf619aec50e6d78e4461ff540234bd4d0c45f7496562fa84b7edd"));
