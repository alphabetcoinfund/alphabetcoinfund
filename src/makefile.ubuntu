...
test check: test_alphabetcoinfund FORCE
	./test_alphabetcoinfund
...
AlphabetCoinFundd: leveldb/libleveldb.a \
...
test_alphabetcoinfund: $(TESTOBJS) $(filter-out obj/init.o,$(OBJS:obj/%=obj/%))
	$(CXX) $(CFLAGS) -o $@ $(LIBPATHS) $^ $(LIBS) $(TESTLIBS)


clean:
	-rm -f AlphabetCoinFundd test_alphabetcoinfund
	-rm -f obj/*.o
	-rm -f obj-test/*.o
	-rm -f obj/*.P
	-rm -f obj-test/*.P
