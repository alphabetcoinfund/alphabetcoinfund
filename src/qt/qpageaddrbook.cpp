    ...
    tab(tab)
{
    ...
    QString toolTipString[6] = {
        ...
        "Show QR code",
        "Sign a message to prove you own a AlphabetCoinFund address",
        "Verify a message to ensure it was signed with a specified AlphabetCoinFund address",
...
//        ui->buttonBox->setVisible(false);
    ...
    case SendingTab:
        ...
        break;
    case ReceivingTab:
        txtBanner = new QStealthBlueInfo(STEALTH_PAGE_ID_RECEIVE_FUN, this);
