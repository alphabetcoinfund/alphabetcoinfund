    ...
    : QLabel(parent)
{
    ...
    pages[k++] = pageSendFUN = new QPageSendFUN(this);
    pages[k++] = pageReceiveFUN = new QPageAddrBook(QPageAddrBook::ForEditing, QPageAddrBook::ReceivingTab, this);
...
void QStealthMain::setModel(WalletModel *model)
{
    ...
    pageSendFUN->setModel(model);
    pageReceiveFUN->setModel(model->getAddressTableModel());
...
void QStealthMain::showOutOfSyncWarning(bool fShow)
{
    ...
    pageSendFUN->showOutOfSyncWarning(fShow);
