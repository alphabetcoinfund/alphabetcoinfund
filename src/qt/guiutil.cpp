...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "AlphabetCoinFund.lnk";
}
...
{
    return GetAutostartDir() / "AlphabetCoinFund.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=AlphabetCoinFund\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("AlphabetCoinFund-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  AlphabetCoinFund-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("AlphabetCoinFund-Qt"));
