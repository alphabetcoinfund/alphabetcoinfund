...

{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a AlphabetCoinFund address (e.g. SGVQhkwomS9tEDhwakwZC9aVqFtzEF1ZVG)"));
#endif
...
void SendCoinsDialog::customizeUI()
{
    ...
    txtBanner = new QStealthBlueInfo(STEALTH_PAGE_ID_SEND_FUN, ui->frmBanner);
